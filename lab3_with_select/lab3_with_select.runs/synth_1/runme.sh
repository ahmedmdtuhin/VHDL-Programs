...
HD_PWD='E:/TUK_Summer2023/Sep 08_2023/Vhdl_eduvance/lab3_with_select/lab3_with_select.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log with_select.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source with_select.tcl
