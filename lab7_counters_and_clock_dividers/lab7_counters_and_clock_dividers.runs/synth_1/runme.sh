...
HD_PWD='E:/TUK_Summer2023/Sep 08_2023/Vhdl_eduvance/lab7_counters_and_clock_dividers/lab7_counters_and_clock_dividers.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab7_counter_and_clock_divider.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab7_counter_and_clock_divider.tcl
