...
HD_PWD='E:/TUK_Summer2023/Sep 08_2023/Vhdl_eduvance/lab5case_select_and_process/lab5case_select_and_process.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log case_select.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source case_select.tcl
