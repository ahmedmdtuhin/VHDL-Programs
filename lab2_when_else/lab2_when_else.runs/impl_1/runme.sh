...
HD_PWD='E:/TUK_Summer2023/Sep 08_2023/Vhdl_eduvance/lab2_when_else/lab2_when_else.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log when_else.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source when_else.tcl -notrace
