...
HD_PWD='E:/TUK_Summer2023/Sep 08_2023/Vhdl_eduvance/lab2_when_else/lab2_when_else.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log when_else.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source when_else.tcl
