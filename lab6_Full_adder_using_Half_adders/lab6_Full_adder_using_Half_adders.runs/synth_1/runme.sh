...
HD_PWD='E:/TUK_Summer2023/Sep 08_2023/Vhdl_eduvance/lab6_Full_adder_using_Half_adders/lab6_Full_adder_using_Half_adders.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab6_Full_adder_using_Half_adders.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab6_Full_adder_using_Half_adders.tcl
