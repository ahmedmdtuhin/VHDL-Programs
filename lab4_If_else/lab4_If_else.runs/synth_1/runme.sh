...
HD_PWD='E:/TUK_Summer2023/Sep 08_2023/Vhdl_eduvance/lab4_If_else/lab4_If_else.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log If_else.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source If_else.tcl
