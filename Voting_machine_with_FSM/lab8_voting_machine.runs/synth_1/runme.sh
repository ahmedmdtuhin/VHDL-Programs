...
HD_PWD='E:/TUK_Summer2023/Sep 08_2023/Vhdl_eduvance/lab8_voting_machine/lab8_voting_machine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab8_voting_machine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab8_voting_machine.tcl
